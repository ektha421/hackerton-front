            ...
            <div className="wrap-signup">
                ...
                <div className="wrap-signup-form">
                    <form action="" onSubmit={onSubmit}>
                        ...
                        {emailError && <div style={{color : 'red', textAlign:'right', padding:'5px 0'}}>이메일 형식에 맞지 않습니다.</div>}
                        ...
                        {passwordError && <div style={{color : 'red', textAlign:'right', padding:'5px 0'}}>비밀번호가 일치하지 않습니다.</div>}
                        <span className="input-area">
